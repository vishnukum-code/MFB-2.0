...
namespace MyFightBook.Modals
{
    ...
    public class User
    {
        ListExists listExists = new ListExists();
        ...
        public List<CountryList> CountryList { get => listExists.countriesData(); }
