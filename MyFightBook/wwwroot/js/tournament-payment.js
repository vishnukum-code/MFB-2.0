var tournamentPayment = function () {
    var getWeightClass = function (fightClassId) {
        ...
        bindFn = function () {
            ...
            $("#registrationId").click(function () {
                let isOk = true;
                let cardnumberId = $("#cardnumberId").val();
                let clubId = $("#ClubId option:selected").index();
                let expiremonth = $("#expiremonth").val();
                let expireyear = $("#expireyear").val();
                let cvcId = $("#cvcId").val();
